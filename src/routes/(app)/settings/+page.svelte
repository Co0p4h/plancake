...
<div class="container flex-1 mx-auto max-w-8xl p-5 bg-white border border-gray-300 rounded-lg relative">
  ...
  {#if schedule_settings}
      {@const s = schedule_settings[0].settings}
      <div class="container flex-1 mx-auto max-w-8xl p-5 bg-white border border-gray-300 rounded-lg flex flex-col gap-7 mb-6">
        <div class="flex justify-between items-center">
          ...
          <Toggle toggled={s.show_empty_days} onclick={() => {}} disabled={false} />
        </div>
        <div class="pl-4 border-l-2 border-gray-300">
          ...
          <input class="border w-1/2 border-gray-300 rounded-sm px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500" value={s.empty_day_text} placeholder={m['_settings.empty_day_text_placeholder']()} />
        </div>
        <div class="flex justify-between items-center">
          <div>
          ...
          <Toggle toggled={s.show_past_events} onclick={() => {}} disabled={false} />
        </div>
        <div class="flex justify-between items-center">
          <div>
          ...
          <Toggle toggled={s.use_24_hour_time} onclick={() => {}} disabled={false} />
        </div>
        <div class="flex justify-between items-center">
          <div>
          ...
          <Toggle toggled={s.show_social_links} onclick={() => {}} disabled={false} />
        </div>
        <div>
