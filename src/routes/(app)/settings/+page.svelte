  ...
  <div class="container flex-1 mx-auto max-w-8xl p-5 bg-white border border-gray-300 rounded-lg relative">
    ...
    {#if schedule_settings}
      <form method="POST" action="?/updateSettings" use:enhance={enhance_form} class="flex-1">
        ...
        <button
          type="submit"
          class="focus:shadow-outline rounded bg-purple-400 px-4 py-2 font-bold text-white hover:bg-purple-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 absolute right-5 bottom-5 transition-all duration-200 ease-in-out cursor-pointer flex items-center"
